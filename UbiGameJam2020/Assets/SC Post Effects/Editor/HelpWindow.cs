...
namespace SCPE
{
    public class HelpWindow : EditorWindow, IHasCustomMenu
    {
        ...
        {
            menu.AddItem(new GUIContent("Open installer"), false, MenuItemOpenInstaller);

#if PACKAGE_MANAGER
            menu.AddItem(new GUIContent("Install LWRP support"), false, MenuItemLWRPInstall);
#endif
        }
        ...
        private static void MenuItemLWRPInstall()
        {
            ...
            if (RenderPipelineInstallation.VersionStatus == RenderPipelineInstallation.Version.Compatible) Installer.DefineSymbol.Add(RenderPipelineInstallation.SRP_DEFINE_SYMBOL);
#endif
        }
