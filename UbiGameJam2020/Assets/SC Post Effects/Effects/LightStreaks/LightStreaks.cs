...
namespace SCPE
{
    ...
    public sealed class LightStreaksRenderer : PostProcessEffectRenderer<LightStreaks>
    {
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            sheet.properties.SetVector("_Params", new Vector4(luminanceThreshold, settings.intensity, 0f, 0f));
            ...
            int iterations = (settings.quality.value == LightStreaks.Quality.Performance) ? settings.iterations * 3 : settings.iterations;
